...
export const Payment_card = () => {
  ...
  return (
    <Card sx={{ display: 'flex', height: '250px', width: width< 900 ? "100%" : "50%" }} component="Paper" elevation={7}>
      <Box sx={{ display: 'flex', flexDirection: 'column' , width: '40%'}}>
        <CardContent sx={{ flex: '1 0 auto' }}>
          <Typography component="div" variant="h5">
            Eid Salami
          </Typography>
          <Typography variant="subtitle2" color="text.secondary" component="div" sx={{ display: "none"}}>
